...
class EnvConfig:
    ...
    stage1c_x: Tuple[float, float] = (0.47, 0.63)
    stage1c_y: Tuple[float, float] = (-0.18, 0.18)

    obj_z: float = 0.02

    # success condition (curriculum)
    success_dist_1a: float = 0.10   # ✅ dễ hơn để bật success nhanh
    success_dist_1b: float = 0.07   # ✅ giữ chuẩn cho 1B
    success_dist_1c: float = 0.04   # (dự kiến) 1C sẽ dùng để test zero-shot từ 1B, nên giữ success_dist như 1B
