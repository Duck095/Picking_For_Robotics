...
class PandaController:
    ...
    def close_gripper(self, width=0.02):
        # width=0.02 nghĩa là mỗi ngón sẽ cách tâm 2cm (tổng bề rộng là 4cm). Vừa khít ôm lấy khối cube_small mà không bị xuyên thấu.
        for j in self.GRIPPER_JOINTS:
            p.setJointMotorControl2(self.robot_id, j, p.POSITION_CONTROL, targetPosition=width, force=200, physicsClientId=self.cid)
